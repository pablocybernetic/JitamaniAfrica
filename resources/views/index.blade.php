...
@section('content')
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="">
                                                        ...
                                                        <h1 class="text-light"
                                                            style="padding-bottom: 0em; margin-bottom: 0rem;">We're not just
                                                            a</h1>
                                           ...
                                           <p class="banner_text" id="banner-text"></p> -->
                                                        ...
                                                        <h1 class="text-light" style="padding-top: 2px;">We're both in equal
                                                            measures.</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="quote-card-1">
                    <p class="quote-text-1">"The size of your dreams must always exceed your current capacity to achieve
                        them. If your dreams do not scare you, they are not big enough."</p>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2 shooting-star-background">
                                ...
                                <div class="section-title ml-lg-5">
                                    <h3 class="text-custom font-weight-normal mb-3 text-muted  fs-6"
                                        style="color: #fff !important;">About Us</h3>
                                    <!-- <h4 class="title mb-4 fs-6" style="color: white;">
                        
    Who Are We?                </h4> -->

                                    <p class="lead fs-5 text-secondary mb-3" style="color: #fff !important;">
                                        Jitamani Africa is a visionary, women-led business development and events
                                        consultancy,
                                        rooted in the rich and diverse African landscape. Our name, derived from the Swahili
                                        term meaning "to desire oneself,"
                                        embodies our mission to inspire Africa to embrace its limitless potential and
                                        inherent glory. Based in Kenya,
                                        we offer bespoke consultancy services across sectors as dynamic as Food, Fashion,
                                        Fitness, Film, Non-Profit,
                                        Tech, Music, and beyond. Our purpose is to empower businesses to reach their full
                                        potential through strategic insight,
                                        innovative event curation, and transformative marketing solutions. At Jitamani
                                        Africa, we are not just shaping businesses—we’re
                                        crafting the future of Africa's creative and entrepreneurial spirit.
                                    </p>
        ...
        <div class="services_section layout_padding">
            <div class="container">
                ...
                <div class="row">
                    <div class="quote-card-1">
                        <p class="quote-text-1">"We are the ones we’ve been waiting for. We are the change that we seek."
                        </p>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h3 class="bitcoin_text" style="color:rgb(255, 255, 255);  text-align: start; ">Business
                                    Development
                                    Consultancy </h3>
                                <p class="services_text" style="color:white;  text-align: start; width: 100%;">

                                    <strong style="font-style: bold; color: rgb(226, 55, 126);">Strategic
                                        Planning:</strong>
                                    We provide comprehensive business planning and strategy
                                    development to help your business navigate the competitive market.
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);">Operational
                                        Efficiency:</strong>
                                    Optimize your operations with our expert guidance to
                                    enhance productivity and profitability.
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);">Market
                                        Analysis:</strong> In-depth
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <!-- <div class="icon_img"><img src="images/icon-1.png"></div> -->
                                <h3 class="bitcoin_text" style="color:white;  text-align: start;">Event Curation &
                                    Execution</h3>
                                <p class="services_text" style="color:white;  text-align: start; width: 100%;">
                                    ...
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);">Execution &
                                        Management:</strong>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <!-- <div class="icon_img"><img src="images/icon-1.png"></div> -->
                                <h3 class="bitcoin_text" style="color:white;  text-align: start;">Marketing Consultancy
                                </h3>
                                <p class="services_text" style="color:white;  text-align: start; width: 100%;">
                                    ...
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);">Digital
                                        Marketing:</strong>
                                    Utilizing digital platforms to enhance your online presence
                                    and engage with your target audience.
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);"> Campaign Management:
                                    </strong>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="services_text" style="color:white;  text-align: start; width: 100%;">
                                    ...
                                    market share.
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);"> Sales
                                        Training:</strong>
                                    Empowering your sales team with the skills and knowledge to
                                    excel.
                                    <br><strong style="font-style: bold; color: rgb(226, 55, 126);">Performance
                                        Monitoring:</strong>
        ...
        <div class="services_section layout_padding" style="background-color: #fff;">
            <div class="container">
                <div class="row">
                    <div class="quote-card-1">
                        <p class="quote-text-1">"It is better to die for an idea that will live, than to live for an idea
                            that will die."</p>
    ...
    <p>  "It is better to die for an idea that will live, than to live for an idea that will die." – Steve Biko
        ...
        <div class="services_section layout_padding " style="background-color: #008080;">
            <div class="container">
                <h1 class="services_taital" style="text-align: center; color: rgb(255, 255, 255) ;">We’re grateful to work
                    with
                ...
                <div class="services_section_2" style="padding-bottom: 1rem;">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/admi.png" alt="Partner 2" class="img-fluid partner-logo"
                                    style="height: 70px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/Deo Media.png" alt="Partner 3" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/Hero-Logo.png" alt="Partner 4" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/If We Build It.webp" alt="Partner 5" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/Remy-Martin-logo.png" alt="Partner 6" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/gtc.png" alt="Partner 7" class="img-fluid partner-logo"
                                    style="height: 130px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/firsteye.png" alt="Partner 7" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/winebox.png" alt="Partner 7" class="img-fluid partner-logo"
                                    style="height: 120px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/Logo22.webp" alt="Partner 7" class="img-fluid partner-logo"
                                    style="height: 40px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/BDC-Roundel.webp" alt="Partner 7" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
                            <div class="col-6 col-md-2 mb-4 p-4 d-flex align-items-center justify-content-center">
                                <img src="images/bahari.png" alt="Partner 7" class="img-fluid partner-logo"
                                    style="height: 100px;">
                            </div>
        ...
        <div class="services_section layout_padding" style="background-color: #fff;">
            <div class="container">
                <div class="row">
                    <div class="quote-card-1">
                        <p class="quote-text-1">"You cannot carry out fundamental change without a certain amount of
                            madness. It comes from nonconformity, the courage to turn your back on the old formulas, the
        ...
        <div class="services_section layout_padding" style="background-color: #fff;">
            <div class="container">
                <div class="row">
                    <div class="quote-card-1">
                        <p class="quote-text-1">"To Drive Brand Distinction, We Design Immersive Experiences Fueled By
